...
```{r}
### xgboost it has faster implementaitons and it has both linear model solver and tree learning algorithms
library(xgboost)
library(readr)
library(stringr)
library(caret)
...
as(df_train,"dgCMatrix")

# combine train and test data
set.seed(1)
xgb <- xgboost(data = df_train[,-18],label=df_train[,18],
               nrounds=2,
